...
def load_and_wrap_ArcFace(model_name="ArcFace"):
    """
    Load the specified DeepFace model and wrap it as a TensorFlow Keras model.

    Parameters:
    - model_name (str): The name of the DeepFace model to load (default: "ArcFace").
...
def save_and_convert_deepface_model(model_name="ArcFace", base_path="./model"):
    """
    ...
    Parameters:
    - model_name (str): Name of the DeepFace model (e.g., "ArcFace").
    - base_path (str): Base directory to save the model.
    """
    print("-" * 50)
    # Load and wrap the DeepFace model
    model = load_and_wrap_ArcFace(model_name=model_name)
...
if __name__ == "__main__":
    save_and_convert_deepface_model(model_name="ArcFace", base_path="./model/ArcFace/")
